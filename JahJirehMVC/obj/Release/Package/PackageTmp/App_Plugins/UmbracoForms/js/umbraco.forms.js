...
function dataSourceResource($http) {
    ...
    var apiRoot = "UmbracoForms/Backoffice/DataSource/";
...
function dataSourceWizardResource($http) {
    ...
    var apiRoot = "UmbracoForms/Backoffice/DataSourceWizard/";
...
function exportResource($http) {
    ...
    var apiRoot = "UmbracoForms/Backoffice/Export/";
...
function formResource($http) {
    //the factory object returned
    var apiRoot = "UmbracoForms/Backoffice/Form/";
...
function licensingResource($http) {
    //the factory object returned
    var apiRoot = "UmbracoForms/Backoffice/Licensing/";
...
function pickerResource($http) {
    ...
    var apiRoot = "UmbracoForms/Backoffice/Picker/";
...
function preValueSourceResource($http) {
    ...
    var apiRoot = "UmbracoForms/Backoffice/PreValueSource/";
...
function recordResource($http) {
    //the factory object returned
    var apiRoot = "UmbracoForms/Backoffice/Record/";
...
function securityResource($http) {
    ...
    var apiRoot = "UmbracoForms/Backoffice/FormSecurity/";
...
function updatesResource($http) {
    //the factory object returned
    var apiRoot = "UmbracoForms/Backoffice/Updates/";
...
function workflowResource($http) {
    ...
    var apiRoot = "UmbracoForms/Backoffice/Workflow/";
